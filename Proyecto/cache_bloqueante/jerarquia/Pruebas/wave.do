...
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/camino_datos_cache/etiquetas/memoria_etiquetas/campo_etiquetas
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/camino_datos_cache/estado/campo_estado
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/camino_datos_cache/datos/memoria_datos/campo_datos
add wave -noupdate -divider {CONTROLADOR de cache}
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/estado
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/prxestado
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/derechos_acceso
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/expulsion_modificado
add wave -noupdate -divider {CONTROLADOR señales internas}
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/pet
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/info_estado
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/s_control
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/resp
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/pet_m
add wave -noupdate -radix hexadecimal /prueba_ensamblado/ensamblado/cache_bloqueante/cach/cache/controlador_cache/resp_m
...
WaveRestoreCursors {{Cursor 1} {43401000 ps} 0}
...
update
WaveRestoreZoom {41456690 ps} {46896178 ps}
