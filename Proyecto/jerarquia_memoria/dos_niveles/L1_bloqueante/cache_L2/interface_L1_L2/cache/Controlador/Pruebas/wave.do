...
add wave -noupdate -radix hexadecimal -childformat {{/prueba_controlador/s_control.DAT_acc -radix hexadecimal} {/prueba_controlador/s_control.DAT_esc -radix hexadecimal} {/prueba_controlador/s_control.EST_acc -radix hexadecimal} {/prueba_controlador/s_control.EST_esc -radix hexadecimal} {/prueba_controlador/s_control.EST_DE -radix hexadecimal -childformat {{/prueba_controlador/s_control.EST_DE(1) -radix hexadecimal} {/prueba_controlador/s_control.EST_DE(0) -radix hexadecimal}}} {/prueba_controlador/s_control.ET_acc -radix hexadecimal} {/prueba_controlador/s_control.ET_esc -radix hexadecimal} {/prueba_controlador/s_control.muxE -radix hexadecimal} {/prueba_controlador/s_control.exp -radix hexadecimal}} -expand -subitemconfig {/prueba_controlador/s_control.DAT_acc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.DAT_esc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.EST_acc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.EST_esc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.EST_DE {-height 15 -radix hexadecimal -childformat {{/prueba_controlador/s_control.EST_DE(1) -radix hexadecimal} {/prueba_controlador/s_control.EST_DE(0) -radix hexadecimal}} -expand} /prueba_controlador/s_control.EST_DE(1) {-height 15 -radix hexadecimal} /prueba_controlador/s_control.EST_DE(0) {-height 15 -radix hexadecimal} /prueba_controlador/s_control.ET_acc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.ET_esc {-height 15 -radix hexadecimal} /prueba_controlador/s_control.muxE {-height 15 -radix hexadecimal} /prueba_controlador/s_control.exp {-height 15 -radix hexadecimal}} /prueba_controlador/s_control
...
add wave -noupdate -radix hexadecimal /prueba_controlador/reg_pet
add wave -noupdate -radix hexadecimal /prueba_controlador/reg_pet_ent
add wave -noupdate -radix hexadecimal /prueba_controlador/reg_s_estado
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {322441 ps} 0}
